...
Current issue is figuring out how to make
...
MENU_LIST const root_list[]   = { &item_checkme, &item_barme, &item_bazme, &item_bakme, &item_state, &item_testme, &item_voltest };
...
void uiSetVolume(){
  ...
  lcd.setCursor(0,1);
    ...
    while( Menu.checkInput() != BUTTON_SELECT ) {
      ...
      lcd.setCursor(0,2);
      lcd.print(myVar);
  //    MIDI.sendControlChange(10, 10, 1);  //need to figure this one out
      delay(2);
    ; // wait!
  }
  Menu.enable(true);
